...
let angka1 = prompt("Angka Pertama");
let angka2 = prompt("Angka Kedua");
let hitungan;
switch (menu) {
  case "1":
  ...
  case "4":
    ...
    break;
  default:
    hitungan = "Keluar Program, terimakasih";
    break;
}

console.log("Hasilnya adalah " + hitungan);*/

// Koreksi yang benarnya
